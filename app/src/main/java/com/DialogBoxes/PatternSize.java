...
public class PatternSize extends Dialog {
    TextView dataTextView, ChoosenText;
    String data[] = {"1 x 1", "2 x 2", "3 x 3", "4 x 4", "5 x 5", "6 x 6", "7 x 7", "8 x 8", "9 x 9", "10 x 10"};
    Context context;
    SharedPreference sP;
    CustomAdapter customAdapter;

    public PatternSize(Context context, final SharedPreference sP, final SettingsAdapter adapter) {
        super(context);
        ...
        textView.setText("Select Pattern Size");
