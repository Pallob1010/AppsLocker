...
public class PatternDot extends Dialog {
    TextView dataTextView, ChoosenText;
    int backgrounds[] = {R.drawable.white_normal,R.drawable.green_normal,R.drawable.blue_normal,R.drawable.red_normal,R.drawable.black_normal};
    ...
    public PatternDot(Context context, final SharedPreference sP, final SettingsAdapter adapter) {
        super(context);
        ...
        textView.setText("Select Pattern Dot");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                sP.setPatternDot(backgrounds[position]);
    ...
    public class CustomAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (sP.patternDot()==backgrounds[position]) {
